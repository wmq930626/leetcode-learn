...
class Solution7 {
    public int myAtoi(String str) {
        ...
        if ((str.charAt(0) < 48 && str.charAt(0) > 57) && str.charAt(0) != 45 && str.charAt(0) != 43){
            return 0;
        }
        String numStr = "";
        int start = 0;
        ...
        if (str.startsWith("-") || str.startsWith("+")){
            numStr = numStr + str.charAt(0);
            start = 1;
        }

        if ((str.startsWith("-") || str.startsWith("+"))&&!(str.charAt(1) >= 48 && str.charAt(1) <= 57)){
           return 0;
        }
